...
@Repository
@Primary
@Qualifier("mySqlDockerRunRepository")
public class MySqlDockerRunRepository implements RunRepository {
    private static final Logger log = LoggerFactory.getLogger(jdbcRunRepository.class);

    private final JdbcTemplate jdbcTemplate;

    public MySqlDockerRunRepository(JdbcTemplate jdbcTemplate) {
